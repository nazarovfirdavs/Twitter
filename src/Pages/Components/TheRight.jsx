...
const TheRight = () => {
  return (
    <div style={{
      ...
      <div>
        <input placeholder='Search Twitter' className='rightInp' type={'text'} />
      ...
      <div>
        ...
        <ul className='listRiht'>
          <li className='itemRight'>
            <div>
              <span className='spanRigt'>
              Trending in Germany
              </span>
